...
window.location = "http://trexlorebk.com/online/main/dashboard.php"
...
window.location = "http://trexlorebk.com/online/user.php"
...
<?php
    ...
    { 
     ...
     </p> <h3 class="gdlr-item-title gdlr-skin-title gdlr-skin-border">Login</h3></div></div><div class="gdlr-item gdlr-content-item" ><div role="form" class="" id="" lang="en-US" dir="ltr">
...
<p>
    <span class="wpcf7-form-control-wrap placeholder"><input type="password"
        name="password"
        placeholder="Password"
        size="9"
        maxlength="8"
        id="password" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" /></span> </p>
<p><input  type="submit" value="Login" name="Signon" id="Signon" class="wpcf7-form-control wpcf7-submit" /></p>
