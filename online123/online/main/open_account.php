...
$open_account = mysql_query("insert into account (act_number,digital_signature,finger_print,scanning_documents) values('".$act_number."','".$digital_signature."','".$finger_print."','".$scanning_documents."')");
}
