...
?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Current Account Transactions</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2>Current Account Transaction Details</h2>
						<div class="box-icon">
                    ...
                    <div class="form-actions">
					  ...
					  <button type="submit" class="btn btn-primary" name="get_transaction">Get Details</button>
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  $transaction_details = mysql_query("SELECT act.cust_atc_type,trans.* FROM act_holder_details act,transaction trans WHERE act.cust_act_number = trans.act_number AND act.cust_atc_type = 'current' AND trans.transaction_date between '".$_REQUEST['form_date']."' AND '".$_REQUEST['to_date']."'");
