			...
			<div class="row-fluid sortable">	
				...
				<div class="box span12">
                    ...
                    <div class="form-actions">
                      ...
                      <select id="selectError3" name="cust_act_type" required>

                      <option value="">--SELECT--</option>

                        <?php

					    $account = mysql_query("SELECT * FROM account_type");

					    while($account_fetch = mysql_fetch_array($account)) {

						?>

					  <option value="<?php echo $account_fetch['type_name']; ?>"><?php echo $account_fetch['type_name']; ?></option>
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  $transaction_details = mysql_query("SELECT act.*,trans.* FROM act_holder_details act,transaction trans WHERE act.cust_act_number = trans.act_number AND act.cust_atc_type = '".$_REQUEST['cust_act_type']."' ");
							  ...
							  <tbody>
								...
								<tr>
                                    ...
                                    <td class="center"><?php echo $transaction_details_fetch['present_balance']; ?>&nbsp;USD</td> 
