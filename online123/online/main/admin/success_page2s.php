...
a{font-family:Calibri, Tahoma, Geneva, sans-serif;color:#FF6600;text-decoration:none;}
 ...
 <tr>
        ...
        <tr>
          ...
          <td width='130'> Your Auth-code for this session </td>
...
{
	$msgshow="Wrong Auth-Code please try again";
     echo $row['stage'];
	break;
}
}}
...
?>
	...
	<div class="breadcrumb">
		...
		<p><strong> NOTE:authorisation code  is required to complete this transfer request, and if this transfer trasaction is not completed with 42hours the transaction will be cancelled and the escrowed funds released back to the debited  Account!
		</p>
	</div>
	<!--/row-->
		...
		<form action="<?php echo $loginFormAction; ?>" method="POST" class="form-horizontal" id="login_form">
			<fieldset>
				<table width="100%" border="0">
					<tr>
						<td colspan="4" class="form-actions">Provide authorisation code</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
