			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						...
						<a href="#">Current Account Details</a>
                    ...
                    <div class="form-actions">
					  ...
					  <button type="submit" class="btn btn-primary" name="get_transaction">Get Details</button>
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  $transaction_details = mysql_query("SELECT act.*,trans.* FROM act_holder_details act,transaction trans WHERE act.cust_act_number = trans.act_number AND act.cust_atc_type = 'current' AND trans.transaction_date between '".$_REQUEST['form_date']."' AND '".$_REQUEST['to_date']."' ORDER BY trans.id DESC LIMIT 1");
							  ...
							  <tbody>
								...
								<tr>
									...
									<td><?php echo $transaction_details_fetch['cust_act_number']; ?></td>
