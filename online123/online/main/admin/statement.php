...
if (isset($_GET['del'])) {
  	...
  	//echo $idtocheck;
	 $del_ok= mysql_query("DELETE  FROM transaction WHERE id= '".$idtocheck."'");
	 if($del_ok)
	 {
	 	echo "Record Deleted";
	 	///header( "Refresh:2; url=#main/admin/statement.php", true, 303);
	 }
	 else
	 {
							  ...
							  <tbody>
								...
								<tr>
									...
									<td class="center"><?php echo $transaction_details_fetch['present_balance']; ?></td>
									  <td>	<?php
echo '<a href="statement.php?del=' .$transaction_details_fetch['id']. '">Delete</a>';
