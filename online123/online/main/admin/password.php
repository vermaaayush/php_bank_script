						  ...
						  <fieldset>
							...
							<div class="control-group">
							 ...
							 <div class="controls">
								  ...
								  <input class="input-xlarge focused" id="focusedInput" type="password" value="" name="last_password" required>
                            ...
                            <div class="control-group">
							 ...
							 <div class="controls">
								  ...
								  <input class="input-xlarge focused" id="focusedInput" type="password" value="" name="password" required>
							...
							<div class="control-group">
							 ...
							 <div class="controls">
								  ...
								  <input class="input-xlarge focused" id="focusedInput" type="password" value="" name="confirm" required>
