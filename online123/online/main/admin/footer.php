		...
		<footer>
			<table cellspacing="2" cellpadding="1px" align="left"  border="0" width="100%" style="border-bottom: 3px solid #c1bead;border-top: 3px solid #c1bead;">
              <tr>
                <td align="left" style="margin-top: 0px; padding-right: 5px; padding-left:10px; border-left: #999999 1px dotted;border-right: #999999 1px dotted;">About Us</td>
                <td align="left" style="margin-top: 0px; padding-left:10px;border-right: #999999 1px dotted;">Your Security</td>
                <td align="left" style="margin-top: 0px; padding-left:10px;border-right: #999999 1px dotted;">Terms &amp; Conditions</td>
                <td align="left" style="margin-top: 0px; padding-left:10px;border-right: #999999 1px dotted;">Consumer Privacy Policy&nbsp; </td>
                <td align="center" width="250" style="border-right: #999999 1px dotted;font-family :Arial;font-size:11px; text-decoration: none;color: #999;font-weight:bold;"> Copyright © <?php echo date('Y') ?> Banco Madrid. Member FDIC. Equal Housing Lender <img src='gif/logo_ehl.gif' alt="Bank of West" width="17" height="13" border="0" /></td>
            </tr>
          </table>
		</footer>
		<?php } ?>
