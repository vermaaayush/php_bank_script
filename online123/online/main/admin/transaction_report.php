			...
			<div class="row-fluid sortable">	
				...
				<div class="box span12">
                    ...
                    <div class="form-actions">
                      ...
                      <select id="selectError3" name="transaction_id" required>

                      <option value="">--SELECT--</option>

                        <?php

					    $account = mysql_query("SELECT DISTINCT transaction_id FROM transaction");

					    while($account_fetch = mysql_fetch_array($account)) {

						?>

					  <option value="<?php echo $account_fetch['transaction_id']; ?>"><?php echo $account_fetch['transaction_id']; ?></option>
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  $transaction_details = mysql_query("SELECT act.*,trans.* FROM act_holder_details act,transaction trans WHERE act.cust_act_number = trans.act_number AND trans.transaction_id = '".$_REQUEST['transaction_id']."' ");
