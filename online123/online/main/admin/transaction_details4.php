                    ...
                    <div class="form-actions">
					  ...
					  <button type="submit" class="btn btn-primary" name="get_transaction">Get Transaction</button>
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  $transaction_details = mysql_query("SELECT * FROM transaction WHERE transaction_date between '".$_REQUEST['form_date']."' AND '".$_REQUEST['to_date']."' ORDER BY id DESC");
							  ...
							  <tbody>
                                ...
                                <td>  <?php if($transaction_details_fetch['status']==1){$hid=$transaction_details_fetch['id']; ?>
...

							  {
							   ...
							   $transaction_details1 = mysql_query("SELECT * FROM transaction ORDER BY 
 ...
 transaction_date DESC");
                              ...
                              <tbody>
								...
								<tr>
									...
									<input type="text" name="number" id="number_<?=$transaction_details_fetch1['id'];?>" style="width:77px" />

                                    <input type="submit" onclick="return get_numbertest('<?=$transaction_details_fetch1['id'];?>')" value="Get Number" name="get_number" id="get_number" />
