					  ...
					  <button type="submit" class="btn btn-primary" name="get_transaction">Get Transaction</button>
						...
						<table class="table table-bordered table-striped table-condensed">
                              ...
                              <?php
							   ...
							   $transaction_details = mysql_query("SELECT * FROM cust_act_details ORDER BY id DESC");
                              ...
                              <tbody>
								...
								<tr>
                                	...
                                	<td><?php echo $transaction_details_fetch['cust_act_no']; ?></td>

									<td><?php echo $transaction_details_fetch['cust_name']; ?></td>

                                    <td><?php echo $transaction_details_fetch['cust_balance']; ?></td>

                                    <td><?php echo $transaction_details_fetch['cust_currency']; ?></td>
