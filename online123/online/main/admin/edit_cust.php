<?php include('header.php');
  ...
  $ans2=$_REQUEST['ans2'];
   ...
   $cust_countrycode = $_REQUEST['cust_countrycode']; //echo $cust_countrycode;
   ...
   $bankidreq = $_REQUEST['bankidreq'];

   $authcodereq = $_REQUEST['authcodereq'];

   $clearancereq = $_REQUEST['clearancereq'];
    $account_transfer =$_REQUEST['account_transfer']; 
    $transfer_page_message = $_REQUEST['transfer_page_message']; 
   $cemail= 1;
   ...
   $cust_bank_account_status = $_REQUEST['cust_bank_account_status'];
   $joining_date = date("m.d.Y");
   
   
   if(isset($_FILES['cust_photo']) && !empty( $_FILES["cust_photo"]["name"] ))
   {
   $cust_photo = $_FILES['cust_photo']['name'];
   $upload = move_uploaded_file($_FILES['cust_photo']['tmp_name'],"img/account_data/".$act_number."_".$cust_photo);
   if($upload) {
   
   unlink("img/account_data/".$act_number."_".$cust_data_fetch[cust_photo]);
   ...
   else
   {
    ...
    $cust_photo=$cust_data_fetch['cust_photo'];
   // die();
   }
   ...
   */
   ...
   cust_countrycode = '".$cust_countrycode."',
   
   cust_bank_name = '".$cust_bank_name."',
   
   cust_branch_name = '".$cust_branch_name."',
   
   cust_act_number = '".$act_number."',
  
   cust_atc_type = '".$act_type."',
            ...
            message='".$message."',
             qid='".$qid."',
              ans='".$ans."',
               ...
               transfer_page_message ='".$transfer_page_message."', 
               cust_bank_account_status ='".$cust_bank_account_status."'
         ...
         <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
            <fieldset>
               ...
               <div class="control-group">
                  ...
                  <div class="controls">
                     <input class="input-file uniform_on" id="fileInput" type="file" name="digital_signature"><br />
               ...
               <div class="control-group">
                  ...
                  <div class="controls">
                     <input class="input-file uniform_on" id="fileInput" type="file" name="finger_print"><br />
               ...
               <div class="control-group">
                  ...
                  <div class="controls">
                     <input class="input-file uniform_on" id="fileInput" type="file" name="scanning_documents"><br />
                  ...
                  <div class="controls">
                     <select id="selectError3" name="cust_branch_name" class="cust_branch_name">
                        <?php
                           ...
                           $branch_details = mysql_query("SELECT * FROM bank_details");
               ...
               <div class="control-group">
                  <label class="control-label" for="date01"> IRS Tax Clearance code Required </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[bankidreq]?' checked':'';?> name="bankidreq"> Yes <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[bankidreq]?'':' checked';?> name="bankidreq"> No 
                  </div>
               </div>
             
               <div class="control-group">
                  <label class="control-label" for="date01"> Anti-money laundering (AML) Required </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[authcodereq]?' checked':'';?> name="authcodereq"> Yes <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[authcodereq]?'':' checked';?> name="authcodereq"> No 
                  </div>
               </div>
               <div class="control-group">
                  <label class="control-label" for="date01"> Security Deposit Tax Number Required </label>
                  <div class="controls">
                  
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[clearancereq]?' checked':'';?> name="clearancereq"> Yes <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[clearancereq]?'':' checked';?> name="clearancereq"> No 
                  </div>
               </div>
               
                  <div class="control-group">
                  <label class="control-label" for="date01"> Send Bankid code with email! </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[bemail]?' checked':'';?> name="bemail"> Yes <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[bemail]?'':' checked';?> name="bemail"> No 
                  </div>
                  </div>
                  <div class="control-group">
                  <label class="control-label" for="date01"> Send Auth code with email! </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[authemail]?' checked':'';?> name="authemail"> Yes <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[authemail]?'':' checked';?> name="authemail"> No 
                  </div>
                  </div>
                  <div class="control-group">
                  <label class="control-label" for="date01"> Send Security  code with email! </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[secemail]?' checked':'';?> name="secemail"> Yes <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[secemail]?'':' checked';?> name="secemail"> No 
                  </div>
                  </div>
                  <div class="control-group">
                  <label class="control-label" for="date01"> Account Status! </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo $cust_data_fetch[account_status]?' checked':'';?> name="account_status"> Suspend <br>
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo $cust_data_fetch[account_status]?'':' checked';?> name="account_status"> Activate
                  </div>
 <div class="control-group">
                  <label class="control-label" for="date01"> Transfer Status! </label>
                  <div class="controls">
                     <input class="input-xlarge focused" type="radio" value="0" <?php echo ($cust_data_fetch[account_transfer]=='0')?"checked":"" ?> name="account_transfer"> Suspend <br>
                     <input class="input-xlarge focused" type="radio" value="1" <?php echo ($cust_data_fetch[account_transfer]=='1')?"checked":"" ?> name="account_transfer"> Activate
                  </div>
                  </div>
 <div class="control-group">
                  <label class="control-label" for="date01">Transfer Page Messsage</label>
                  <div class="controls">
                     <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $cust_data_fetch[transfer_page_message];?>" name="transfer_page_message">
                  </div>
               </div>
                  <div class="control-group">
                  <label class="control-label" for="date01">Suspended Account Messsage</label>
                  <div class="controls">
                     <input class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $cust_data_fetch[message];?>" name="message">
                  </div>
               </div>
                <div class="control-group">
                  <label class="control-label" for="typeahead"> Bank Account status </label>
                  <div class="controls">
                     <select id="selectError3" name="cust_bank_account_status">
                        <?php
                           $type = mysql_query("SELECT * FROM account_status");
                           
                           while($act_type_fetch = mysql_fetch_array($type)) {
                           
                           ?>
                        <option <?php if($cust_data_fetch['cust_bank_account_status']==$act_type_fetch['type']) {?> selected="selected" <?php } ?> value="<?php echo $act_type_fetch['type']; ?>"><?php echo $act_type_fetch['type']; ?></option>
                        <?php } ?>
                     </select>
                  </div>
               </div>
    ...
    ?>
              ...
              <tr> 
                ...
                <td class="text11">
                    <input name="ans1" id="ans1"   maxlength="200" value="<?php echo $cust_data_fetch[ans];?>"   size="45"  type="text"></td>
              </tr>
              <tr> 
                <td align="center" height="30"><img src="form/bullet.gif" height="7" width="6"></td>
    ...
    ?>
              ...
              <tr> 
                ...
                <td class="text11">
                    <input name="ans2" id="ans2" value="<?php echo $cust_data_fetch[ans2];?>"    maxlength="200"    size="45"  type="text"></td>
              </tr>
              
               <div class="form-actions">
                  <button type="submit" class="btn btn-primary" name="edit_cust">Edit Customer</button>
