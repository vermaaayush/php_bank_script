			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						...
						<a href="#">Branch Transaction Details</a>
			...
			<div class="row-fluid sortable">	
				...
				<div class="box span12">
					...
					<div class="box-header well" data-original-title>
						...
						<h2>Branch Transaction Details</h2>
                    ...
                    <div class="form-actions">
					  ...
					  <button type="submit" class="btn btn-primary" name="get_transaction">Get Details</button>
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  $transaction_details = mysql_query("SELECT act.*,trans.* FROM act_holder_details act,transaction trans WHERE act.cust_act_number = trans.act_number AND act.cust_branch_name = '".$_REQUEST['cust_branch_name']."' ");
