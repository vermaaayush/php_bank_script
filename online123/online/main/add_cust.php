...
$insert_cust = mysql_query("insert into act_holder_details (cust_name,cust_photo,cust_sex,cust_mail,cust_phone,cust_password,cust_address,cust_countrycode,cust_branch_name,cust_act_number,cust_atc_type,joining_date,digital_signature,finger_print,scanning_documents,user_id,customer_id) values('".$cust_name."','".$cust_photo."','".$cust_sex."','".$cust_mail."','".$cust_phone."','".$cust_password."','".$cust_address."','".$cust_countrycode."','".$cust_branch_name."','".$act_number."','".$act_type."','".$joining_date."','".$digital_signature."','".$finger_print."','".$scanning_documents."','".$user_id."','".$customer_id."')");
	...
	$subject="Trexlore Bank Registration";
...
$message = $client->account->sms_messages->create("+18662894607", "+$cust_countrycode$cust_phone", "Dear Valued Customer, your account opening information is Account Name:$cust_name,Account No:$act_number.Thank you for choosing Trexlore Bank", array());
