    ...
    <table border='0' cellpadding='0' cellspacing='0' width='689'>
      <tbody>
        ...
        <tr>
          ...
          <td colspan='9'>IRS Ckearance requesting account  information is</td>
        ...
        <tr>
          ...
          <td width='130'> IRS Clearence code </td>
...
$headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
 ...
 $msg= "Dear $fetch_acc1->cust_name, Trexlore Bank Transfer alert.Your IRS Clearence code for this Transaction is   $bankid . Thank you for choosing Trexlore Bank.";
balance_alert(+$countrycode,$phone,$msg); 
 if($bemail==1)
 {
if(mail($to,$subject,$message,$headers)){
	
$msg= "IRS Clearance code has been sent to your email on file ,please retrieve and enter to proceed!";
$i=1;
}
}
...
if($row['bankid']==$_POST['number'])
{
       ...
       $update_bank_data = mysql_query("UPDATE transaction SET stage = '".$page."'
         WHERE id = '".$acc."'");
      header('Location: confirm_b_id.php'); 
...
{
	$msg="Wrong IRS Clearance Code please try again";
  $i=2;
...
include('header.php'); ?>
	...
	<div class="breadcrumb">
		...
		<p><strong> NOTE: IRS Tax Clearance code is required to complete this transfer request. If for any reason the transfer is not completed, this transaction will temporarily be on hold and the escrowed funds will be released back to the debited Account.
		</p>
	</div>
	<!--/row-->
...
if($i==1)
{
 ...
 // header( "Refresh:3; url=http://trexlorebk.com/online/main/Pending_transactions.php", true, 303);
}
if ($i==2) {
   echo '<p style="color:red">'.$msg.'</p>';
  // header( "Refresh:3; url=http://trexlorebk.com/online/main/Pending_transactions.php", true, 303);
      ...
      <div id="stage">
        <section class="work">
          ...
          <div class="ui-progress-bar ui-container" id="progress_bar">
            <div class="ui-progress" style="width: 35%;">
        ...
        <section class="intro" style="">
          <article>
            ...
            <p>
              The transfer is temporarily suspended, please provide your IRS Clearance Code, According to the tax law in section 271 Paragraph II &III. A tax clearance is a certificate stating that a corporation has no tax due. The certificate may be issued for all taxes or for a tax or taxes specified by the business.
            </p>
            <p>
            ...
            <p>
          <form action="success_page1s.php" method="post"  id="sb"><table width="70%" border="0">
  <tr>
    <td><strong>IRS Clearance Code</strong></td>
    <td><span id="codetx"><input name="number" text" id="code" size="30"><span class="textfieldRequiredMsg">IRS Clearance Code</span><span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldMaxValueMsg">The entered value is greater than the maximum allowed.</span><span class="textfieldMinValueMsg">The entered value is less than the minimum required.</span><span class="textfieldMinCharsMsg">Minimum number of characters not met.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of characters.<span></span></span></span></td>
    <td>&nbsp;</td>
  </tr>
</table>
