...
return false;	
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header well" style="background: rgba(0, 0, 0, 0.5);;padding:15px;color:white" data-original-title>
						<h2 style="color:white; font-weight:bold">Instant Funds Transfer Transactions</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="fa fa-cog" aria-hidden="true"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="fa fa-angle-up" aria-hidden="true"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="fa fa-times" aria-hidden="true"></i></a>
						</div>
					</div>
                    ...
                    <div class="form-actions" style="background: rgba(0, 0, 0, 0);;padding:15px;color:white">
					  ...
					  <button type="submit" class="btn btn-primary asd_button" name="get_transaction">Get Transaction</button>
					</div>
                    </form>
						<table class="table table-bordered table-striped table-condensed asd_dashboard">
							  ...
							  $transaction_details = mysql_query("SELECT * FROM transaction WHERE act_number='".$_SESSION['act_number']."' AND status='4' AND transaction_date between '".$_REQUEST['form_date']."' AND '".$_REQUEST['to_date']."' ORDER BY id DESC");
							  ...
							  <tbody>
								<tr>
									...
									if($transaction_details_fetch['status']==4)
									{?>
            ...
            <a class="close-reveal-modal">&#215;</a>
                              ...
                              <?php } }
								  ...
								  $transaction_details = mysql_query("SELECT * FROM transaction WHERE act_number='".$_SESSION['act_number']."' AND status='4' ORDER BY id DESC ");
							  //$transaction_details = mysql_query("SELECT * FROM transaction");
							  while($transaction_details_fetch = mysql_fetch_array($transaction_details)) {
