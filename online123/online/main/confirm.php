...
if($bnkid==1)
         {
$MM_redirectLoginSuccess = "success_page1s.php?id=".$_SESSION['idforproc'];
header('Location: '.$MM_redirectLoginSuccess);
         } 
         else if($authid==1 && $bnkid==0)
         {
$MM_redirectLoginSuccess = "success_page2s.php?id=".$_SESSION['idforproc'];
header('Location: '.$MM_redirectLoginSuccess);
         }
         else if($s_code==1 && $authid==0 && $bnkid==0)
         {
$MM_redirectLoginSuccess = "sucess_page3s.php?id=".$_SESSION['idforproc'];
header('Location: '.$MM_redirectLoginSuccess);
         }
         else
         {
      $MM_redirectLoginSuccess = "tranc_page.php?id=".$_SESSION['idforproc'];
header('Location: '.$MM_redirectLoginSuccess);
         }
       }
