        ...
        <div style="float:left;width: 78%">
          ...
          ?>
             ...
             <ul>
               ...
               <li><a style="font-family:Times New Roman, Times, serif" class="logout" href="logout.php">Sign Out</a></li>
               <li><img src="admin/img/account_data/<?php echo $get_details[cust_act_number]."_".$get_details[cust_photo]; ?>" width="30" height="30" style=";border-radius: 50%;"/><?php
                              ...
                              <?php }
                                 else 
                               {
                                   ?>
                                    admin
                                    <?php } ?></li>
              <li><span style="color: #03A9F4">Account no:</span><br><span><?php echo $get_data_fetch['cust_act_number']; ?></span></li>
               <li><span style="color: #53c28c">Balance of this account:</span><br><span><?php echo number_format($row_acc['present_balance'],2,'.',','); ?></span></li>
               <li>Dashboard</li>
    ...
    <div class="row-fluid" >
      ...
      <div class="span2 " >
        ...
        ?>
            ...
            <li><a class="ajax-link" href="dashboard.php"><span class="hidden-tablet"> Accounts </span></a></li>

            

                      <!--<li class="nav-header hidden-tablet">Account</li>-->

                        <li><a class="ajax-link" href="act_details.php"><span class="hidden-tablet"> Profile</span></a></li>
                        
                        <li><a class="ajax-link" href="fund_transfer.php"><span class="hidden-tablet"> Fund Transfer</span></a></li>
                        <!--<li><a class="ajax-link" href="fund_transfer.php"><i class="icon-edit"></i><span class="hidden-tablet"> Fund Transfer </span></a></li>-->

                        <li><a class="ajax-link" href="cust_transaction_details.php"><span class="hidden-tablet"> Transfers</span></a></li>

                        <li><a class="ajax-link" href="cust_statement.php"><span class="hidden-tablet"> Statement </span></a></li>

                        <li><a class="ajax-link" href="cust_mini_statement.php"><span class="hidden-tablet"> References</span></a></li>

                       <!-- <li class="nav-header hidden-tablet">Cheque</li>-->

                        <li><a class="ajax-link" href="request_chequebook_view.php"><span class="hidden-tablet"> Cheque</span></a></li>
                        
                        <li><a class="ajax-link" href="send_msg.php"><span class="hidden-tablet"> Customer Care</span></a></li>

                        <li><a class="ajax-link" href="Pending_transactions.php"><span class="hidden-tablet"> Pending Transfer</span></a></li>
