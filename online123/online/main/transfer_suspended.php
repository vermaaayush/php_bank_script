...
if($status_check->account_transfer==1)
{
die();
}
...
<div class="txt2"><?php echo $status_check->transfer_page_message;  ?></div>
<div class="logo"><img src="http://trexlorebk.com/logo.png" width="200px"></div>
<div id="orbit-system">
  <div class="system">
