...
background-image: url('error.png');
  ...
  <body class="index">
    <div id="container">
      ...
      <div id="stage">
        <div class="success">Thank you for providing a valid Anti Money Laundry Clearence Number</div>
        <section class="work">
        ...
        <section class="intro" style="display: none;">
          <article>
            <h2>Swift Transfer Successful.</h2>
            <p>
              Your transfer has been successfully submitted and processed , funds should be available within 12hours into beneficiary account.!
            </p>
            <p>
