...
.btnt:hover {
  ...
  <body class="index">
    <div id="container">
      ...
      <div id="stage">
        <section class="work">
          <h3> Your transfer request has been successfully submitted, thanks for your patience</h3>
        ...
        <section class="intro" style="display: none;">
          <article>
            <h2>Swift Transfer Completed.</h2>
            <p>
              The transfer has been successfully submitted for processing by our Forex Department.
            </p>
            <p>
