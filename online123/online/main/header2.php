...
<body>
	...
	<div class="navbar">
        ...
        <span style="float:left;"><img src="images/short_logo.png" width="58" height="57" alt="slogo"></span><span style="float:left;"><img src="images/bank_letter.png" width="200" height="52" alt="letter"></span>
...
<div class="container-fluid">
		...
		<div class="btn-group pull-right" >
    			...
    			<td><a href="view_msg.php">My Message</a></td>

    			<td><a href="act_details.php">My Profile</a></td>

    			<td><a href="send_msg.php">Customer Support</a></td>

    			<td><a href="#">Register For : </a></td>  
					...
					<ul class="dropdown-menu">
						...
						<li><a href="http://bahrainsouths.com/ebank/">Logout</a></li>
			...
			<div class="span2 main-menu-span">
				...
				?>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="view_bank.php"><i class="icon-edit"></i><span class="hidden-tablet"> Bank create </span></a></li>
                        ...
                        <li><a class="ajax-link" href="bank_report.php"><i class="icon-edit"></i><span class="hidden-tablet"> Bank wise </span></a></li>
				...
				?>
                    ...
                    <ul class="nav nav-tabs nav-stacked main-menu">
						...
						<!--<li><a class="ajax-link" href="dashboard.php"><i class="icon-home"></i><span class="hidden-tablet"> Account Summary </span></a></li>-->

						

                        <!--<li class="nav-header hidden-tablet">Account</li>-->

                        <li><a class="ajax-link" href="dashboard.php"><i class="icon-edit"></i><span class="hidden-tablet"> Accounts </span></a></li>
